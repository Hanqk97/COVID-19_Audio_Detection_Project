...
def apply_time_stretch(audio, rate):
    ...
    # Apply time stretching on the magnitude
    stretched_magnitude = librosa.effects.time_stretch(magnitude, rate)

    # Reconstruct the STFT with the stretched magnitude and original phase
    stretched_stft = stretched_magnitude * phase
