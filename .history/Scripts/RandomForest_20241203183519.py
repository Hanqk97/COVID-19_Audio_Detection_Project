...
def train_and_evaluate(data, model_name="RandomForest"):
    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(data), 1):
        ...
        # Update best model if the F1 score is the highest so far
        if f1 > best_f1:
            best_f1 = f1
            best_model = model
    ...
    if best_model is not None:
        ...
        print(f"Best model saved to {best_model_path} with F1 score: {best_f1:.4f}")
