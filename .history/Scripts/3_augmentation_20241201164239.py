...
def augment_audio(file_path, output_dir, subject_id, file_type, aug_index):
    ...
    # Add time stretching
    stretch_rate = np.random.uniform(0.8, 1.2)  # Stretch rate between 80% and 120% of the original
    augmented_audio = apply_time_stretch(augmented_audio, rate=stretch_rate, sr=sr)
